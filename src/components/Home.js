...
const Home = () => {
	const product_details = [
		{
			"product_name": "casting pully",
			style: {
				"backgroundImage": 'url(images/pulley-casting.jpg)'
			}
		},
		{
			"product_name": "Casting V belt Pulley",
			style: {
				"backgroundImage": 'url(images/cast-iron-v-belt-pulley.jpg)'
			}
		},
		{
			"product_name": "Knurling Parts",
			style: {
				"backgroundImage": 'url(images/Knurling_Parts.jpeg)'
			}
		},
		{
			"product_name": "Knurling Nuts",
			style: {
				"backgroundImage": 'url(images/Knurled_nuts.jpg)'
			}
		},
		{
			"product_name": "Brass Parts",
			style: {
				"backgroundImage": 'url(images/brass_parts.jpeg)'
			}
		},
		{
			"product_name": "Spray Ball",
			style: {
				"backgroundImage": 'url(images/spray-ball.jpg)'
			}
		},
		{
			"product_name": "SMS Union",
			style: {
				"backgroundImage": 'url(images/sms_union.jpeg)'
			}
		},
		{
			"product_name": "Flange",
			style: {
				"backgroundImage": 'url(images/flange.jpg)'
			}
		},
	]
	useEffect(() => {
